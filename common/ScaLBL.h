...
* @param Np - size of local sub-domain (derived from Domain structure)
*/
extern "C" void ScaLBL_D3Q19_AAeven_Color(int *Map, double *dist, double *Aq, double *Bq, double *Den, double *Phi, signed char *IDSolid, bool *Interfacemap, double *ColorGrad,
...
extern "C" void ScaLBL_D3Q19_AAodd_Color(int *NeighborList, int *Map, double *dist, double *Aq, double *Bq, double *Den, 
		double *Phi, signed char *IDSolid, bool *Interfacemap, double *ColorGrad, double *Vel, double rhoA, double rhoB, double tauA, double tauB, double alpha, double beta,
		double Fx, double Fy, double Fz, int strideY, int strideZ, int start, int finish, int Np);
...
extern "C" void ScaLBL_Interfacemap_Init(int *Map, signed char *IDSolid, bool Interfacemap, int strideY, int strideZ, int start, int finish);
